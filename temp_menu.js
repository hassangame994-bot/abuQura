...
// Import custom generated premium food images
const sausageSandwichImg = "mock_img_path";
const stuffedPigeonImg = "mock_img_path";
const hawawshiImg = "mock_img_path";
const egyptianFattaImg = "mock_img_path";
const okraTajineImg = "mock_img_path";
const oxtailTajineImg = "mock_img_path";
const macBechamelImg = "mock_img_path";
const bakedRicePuddingImg = "mock_img_path";
const omAliImg = "mock_img_path";
...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    category: 'chicken_grills',
    price: 680,
    description: 'بطة بلدي كاملة مستوية في الفرن مع التتبيلة والمكسرات'
  },
  {
    id: 'half_batta',
    name: 'نصف بطة بلدي',
    category: 'chicken_grills',
    price: 350,
    description: 'نصف بطة بلدي مستوية في الفرن ومحمرة بالسمن البلدي'
  },
  ...
  },
  {
    ...
    category: 'sandwiches',
    price: 90,
    description: 'كفتة كندوز مشوية على الفحم تقدم مع مخلل وطحينة'
  },
  {
    ...
    category: 'sandwiches',
    price: 100,
    description: 'رغيف حواوشي بلدي غني باللحم الضاني المتبل والمستوي ببراعة'
  },
  {
  ...
  {
    id: 'kabd_kalawi',
    name: 'كبد وكلاوي مشوي (بالوزن)',
    category: 'meat_grills',
    sizes: ['ربع', 'تلت', 'نص', 'كيلو'],
    price: { 'ربع': 205, 'تلت': 225, 'نص': 305, 'كيلو': 600 },
  ...
  // المطبخ الشرقي والمعجنات والمكرونة
  {
    ...
    price: 400,
    description: 'موزة ضاني بلدي مستوية في الفرن ببطء حتى تذوب مع التوابل الشرقية'
  },
  {
    id: 'ouzi_sada',
    name: 'أوزي سادة فاخر',
  ...
  },
  {
    ...
    category: 'oriental_kitchen',
    price: 175,
    description: 'طبق مشكل كبير من الكوسا والباذنجان والفلفل وورق العنب والكرنب'
  },
  {
    id: 'mahshi_med',
    name: 'محشي مشكل وسط',
  ...
  },
  {
    ...
    category: 'oriental_kitchen',
    price: 80,
    description: 'أصابع محشي كرنب مسبك بالسمن البلدي والصلصة ومستوي ببراعة'
  },
  {
    id: 'mombar',
  ...
  {
    id: 'mac_bolognese',
    name: 'مكرونة اسباكيتي بلونيز',
    category: 'oriental_kitchen',
    price: 110,
    description: 'مكرونة اسباكيتي تقدم مع صوص طماطم غني باللحم المفروم المتبل'
  },
  {
    id: 'mac_sada',
  ...
  },
  {
    ...
    category: 'tajines',
    price: 275,
    description: 'طاجن ملوخية خضراء طازجة تقدم مع قطع لحم بلدي مستوي'
  },
  {
    id: 'tj_msaqaa',
  ...
  // ورقة وطاسة
  {
    ...
    category: 'tajines',
    price: 270,
    description: 'قطع اللحم البلدي الفاخر مغلفة في ورق الزبدة والفويل مع الخضار المتبل ومستوية بالفرن'
  },
  {
    id: 'warqat_sojok',
  ...
  // ركن الوجبات الفردية
  {
    ...
    category: 'meals',
    price: 190,
    description: 'شرائح بانيه مقلي ذهبي + بطاطس مقرمشة + مكرونة اسباكيتي بصلصة أبو قورة اللذيذة'
  },
  {
    id: 'wj_shd_grill',
  ...
  // لحمة مندي
  {
    ...
    category: 'oriental_kitchen',
    price: 420,
    description: 'نفر لحم مندي بلدي فاخر مستوي في حفرة المندي تقدم مع أرز مندي ودقوس'
  },
  {
    id: 'thomn_teis',
  ...
  },
  {
    ...
    category: 'oriental_kitchen',
    price: 1500,
    description: 'ربع تيس بلدي مندي مستوي على الأصول ليكون طرياً جداً مع الأرز المندي الفاخر'
  },
  {
    id: 'nos_teis',
  ...
  },
  {
    ...
    category: 'oriental_kitchen',
    price: 360,
    description: 'قطع كوارع بلدي مخلاة مستوية فوق طبق الفتة المصري بالخل والثوم والصلصة'
  },
  {
    id: 'fatta_meat_fried',
  ...
  },
  {
    ...
    category: 'sides',
    price: 40,
    description: 'خضار مشكل مستوي على البخار خفيف وصحي'
  },
  ...
  },
  {
    ...
    category: 'oriental_kitchen',
    price: 40,
    description: 'أرز مصري أبيض مستوي بالسمن البلدي بطعم زمان'
  },
  {
    id: 'rz_kholta',
  ...
  {
    id: 'ds_rz_forn',
    name: 'طاجن رز بلبن في الفرن بلدي',
  ...
  },
  {
    ...
    category: 'drinks_desserts',
    price: 55,
    description: 'رقائق المطبخ باللبن الساخن والقشطة والمكسرات والزبيب وجوز الهند'
  },
  {
    id: 'ds_konafa',
...
module.exports = { CATEGORIES, MENU_ITEMS, ITEM_SPECIFIC_IMAGES, CATEGORY_IMAGES };
